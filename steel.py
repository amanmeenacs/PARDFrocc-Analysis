...
def steel(majority=[0], frac=1, scaled=True, normalized=True):
    import sklearn.datasets as skds
...
x_train, y_train, x_train2, y_train2, x_val, y_val, x_test, y_test = steel(majority=[0], frac=1,scaled=True, normalized=True)