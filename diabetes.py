...
def diabetes(majority=["tested_negative"], frac=1, scaled=True, normalized=True):
    import sklearn.datasets as skds
    ...
    if os.path.isdir(datadir):
        ...
        # print(22)
        x,y = skds.fetch_openml(data_id=37, return_X_y=True)
        # print(x)
        y.replace(['tested_positive', 'tested_negative'],[0, 1], inplace=True)
...
x_train, y_train, x_train2, y_train2, x_val, y_val, x_test, y_test = diabetes(majority=["tested_negative"], frac=1, scaled=True, normalized=True)
